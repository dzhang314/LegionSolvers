...
KOKKOS_4_3_URL: str = "https://github.com/kokkos/kokkos/archive/refs/tags/4.3.01.zip"


_KOKKOS_CUDA_LIB_NAME: str = "kokkos-4.3.01-cuda"
_KOKKOS_NOCUDA_LIB_NAME: str = "kokkos-4.3.01-nocuda"
...
def main():
    ...
    remove_directory("kokkos-4.3.01")
    download(KOKKOS_4_3_URL)
    run("unzip", "4.3.01.zip")

    with change_directory("kokkos-4.3.01"):
