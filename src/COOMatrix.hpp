  ...
  public:
    explicit COOMatrix(Legion::LogicalRegion matrix_region,
        ...
        for (Legion::PointInDomainIterator<1> input_iter{
            ...
            for (Legion::PointInDomainIterator<1> output_iter{
                ...
                Legion::TaskLauncher launcher{IS_NONEMPTY_TASK_ID,
                                              Legion::TaskArgument{nullptr, 0}};
                launcher.add_region_requirement(Legion::RegionRequirement{
                    tile, READ_ONLY, EXCLUSIVE, matrix_region});
    ...
    void launch_matmul(Legion::LogicalRegion output_vector,
                       ...
                       Legion::Runtime *rt) {
        {
            ...
            launcher.add_region_requirement(Legion::RegionRequirement{
                rt->get_logical_partition(output_vector, output_partition), 0,
                WRITE_DISCARD, EXCLUSIVE, output_vector});
        ...
        for (const auto [input_color, output_color] : nonempty_tiles) {
            ...
            const Legion::FieldID fids[3] = {fid_i, fid_j, fid_entry};
            {
                ...
                launcher.add_region_requirement(Legion::RegionRequirement{
                    output_subregion, READ_WRITE, EXCLUSIVE, output_vector});
                launcher.add_field(0, output_fid);
                launcher.add_region_requirement(Legion::RegionRequirement{
                    tile, READ_ONLY, EXCLUSIVE, matrix_region});
                ...
                launcher.add_region_requirement(Legion::RegionRequirement{
                    input_subregion, READ_ONLY, EXCLUSIVE, input_vector});
