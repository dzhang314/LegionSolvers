...
void LegionSolvers::preregister_solver_tasks(bool verbose) {
    ...
    LegionSolvers::RandomFillTask <float , 1, int      >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <float , 1, unsigned >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <float , 1, long long>::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <float , 2, int      >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <float , 2, unsigned >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <float , 2, long long>::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <float , 3, int      >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <float , 3, unsigned >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <float , 3, long long>::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 1, int      >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 1, unsigned >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 1, long long>::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 2, int      >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 2, unsigned >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 2, long long>::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 3, int      >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 3, unsigned >::preregister_cpu(verbose);
    LegionSolvers::RandomFillTask <double, 3, long long>::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 1, int      >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 1, unsigned >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 1, long long>::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 2, int      >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 2, unsigned >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 2, long long>::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 3, int      >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 3, unsigned >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<float , 3, long long>::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 1, int      >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 1, unsigned >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 1, long long>::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 2, int      >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 2, unsigned >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 2, long long>::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 3, int      >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 3, unsigned >::preregister_cpu(verbose);
    LegionSolvers::PrintVectorTask<double, 3, long long>::preregister_cpu(verbose);
    ...
    LegionSolvers::ScalTask<float , 1, int      >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<float , 1, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<float , 1, long long>::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<float , 2, int      >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<float , 2, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<float , 2, long long>::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<float , 3, int      >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<float , 3, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<float , 3, long long>::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 1, int      >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 1, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 1, long long>::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 2, int      >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 2, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 2, long long>::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 3, int      >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 3, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::ScalTask<double, 3, long long>::preregister_kokkos(verbose);

    LegionSolvers::AxpyTask<float , 1, int      >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<float , 1, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<float , 1, long long>::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<float , 2, int      >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<float , 2, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<float , 2, long long>::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<float , 3, int      >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<float , 3, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<float , 3, long long>::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 1, int      >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 1, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 1, long long>::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 2, int      >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 2, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 2, long long>::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 3, int      >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 3, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::AxpyTask<double, 3, long long>::preregister_kokkos(verbose);

    LegionSolvers::XpayTask<float , 1, int      >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<float , 1, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<float , 1, long long>::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<float , 2, int      >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<float , 2, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<float , 2, long long>::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<float , 3, int      >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<float , 3, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<float , 3, long long>::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 1, int      >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 1, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 1, long long>::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 2, int      >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 2, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 2, long long>::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 3, int      >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 3, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::XpayTask<double, 3, long long>::preregister_kokkos(verbose);

    LegionSolvers::DotTask <float , 1, int      >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <float , 1, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <float , 1, long long>::preregister_kokkos(verbose);
    LegionSolvers::DotTask <float , 2, int      >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <float , 2, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <float , 2, long long>::preregister_kokkos(verbose);
    LegionSolvers::DotTask <float , 3, int      >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <float , 3, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <float , 3, long long>::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 1, int      >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 1, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 1, long long>::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 2, int      >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 2, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 2, long long>::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 3, int      >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 3, unsigned >::preregister_kokkos(verbose);
    LegionSolvers::DotTask <double, 3, long long>::preregister_kokkos(verbose);
