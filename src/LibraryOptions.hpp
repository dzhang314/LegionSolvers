...
#define LEGION_SOLVERS_USE_F32 true
#define LEGION_SOLVERS_USE_F64 true
...
#ifndef LEGION_SOLVERS_SHARDING_FUNCTOR_ID
constexpr Legion::ShardingID LEGION_SOLVERS_SHARDING_FUNCTOR_ID = 2'000;
#endif // LEGION_SOLVERS_SHARDING_FUNCTOR_ID
