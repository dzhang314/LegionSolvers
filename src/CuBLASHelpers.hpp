...
template <typename ENTRY_T>
void cublasSCAL(
    cublasHandle_t handle, int n, const ENTRY_T *alpha, ENTRY_T *x, int incx
) {
    assert(false);
}

template <>
void cublasSCAL<float>(
