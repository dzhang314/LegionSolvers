#ifndef LEGION_SOLVERS_ABSTRACT_MATRIX_HPP
#define LEGION_SOLVERS_ABSTRACT_MATRIX_HPP
    ...
    public:
        ...
        virtual Legion::IndexPartition domain_partition_from_range_partition(
            ...
            return domain_partition_from_kernel_partition(
                domain_space,
                kernel_partition_from_range_partition(range_partition)
            );
        }
...
#endif // LEGION_SOLVERS_ABSTRACT_MATRIX_HPP
