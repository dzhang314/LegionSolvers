...
void top_level_task(
...

    {
        ...
        const auto temp_matrix_partition = rt->create_equal_partition(
            ctx, matrix_index_space, vector_color_space
        );

        {
            const typename LegionSolvers::FillCOONegativeLaplacianTask<
                ...
                KERNEL_COORD_T,
                DOMAIN_COORD_T,
                RANGE_COORD_T>::Args args{FID_I, FID_J, FID_ENTRY, grid_size};
