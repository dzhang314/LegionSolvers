...
void top_level_task(const Legion::Task *,
    ...
    // for (Legion::coord_t vector_size = 900; vector_size <= 905; ++vector_size) {
    ...
    //             rt->create_index_space(ctx, Legion::Rect<VECTOR_DIM, VECTOR_COORD_T>{0, vector_size - 1});
    //         const Legion::IndexSpaceT<VECTOR_COLOR_DIM, VECTOR_COLOR_COORD_T> color_space =
    //             rt->create_index_space(ctx, Legion::Rect<VECTOR_COLOR_DIM, VECTOR_COLOR_COORD_T>{0, num_colors - 1});

    //         LegionSolvers::DistributedVectorT<double, VECTOR_DIM, VECTOR_COLOR_DIM, VECTOR_COORD_T, VECTOR_COLOR_COORD_T> u{"u", index_space, color_space, ctx, rt};
    //         LegionSolvers::DistributedVectorT<double, VECTOR_DIM, VECTOR_COLOR_DIM, VECTOR_COORD_T, VECTOR_COLOR_COORD_T> v{"v", u.index_partition, ctx, rt};
    //         LegionSolvers::DistributedVectorT<double, VECTOR_DIM, VECTOR_COLOR_DIM, VECTOR_COORD_T, VECTOR_COLOR_COORD_T> w{"w", u.index_partition, ctx, rt};
    //         LegionSolvers::DistributedVectorT<double, VECTOR_DIM, VECTOR_COLOR_DIM, VECTOR_COORD_T, VECTOR_COLOR_COORD_T> x{"x", u.index_partition, ctx, rt};
    ...
    //         // v.print();
    //         assert(v.dot(v).get_value() < 1.0e-20);
